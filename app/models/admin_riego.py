...
class AdminRiego:
    def __init__(self,id=None,tipoRiego=None,nad=None,efectividad=None,caudal=None,distancia=None, radio=None) -> None:
        self._id = id
    ...
    def __str__(self) -> str:
        return f'''
            Id admin_riego: {self._id}, Tipo riego: {self._tipoRiego} , nad: {self._nad},
